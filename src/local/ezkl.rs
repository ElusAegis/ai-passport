...
pub(super) async fn compile_circuit(model_path: &Path, settings_path: &Path, compiled_circuit_path: &Path) -> Result<String, EZKLError> {
...
pub(super) async fn setup_keys(compiled_circuit_path: &Path, srs_path: &Path, pk_path: &Path, vk_path: &Path) -> Result<String, EZKLError> {
...
pub(super) async fn generate_witness(compiled_circuit_path: &Path, input_json: &Path, witness_path: &Path) -> Result<String, EZKLError> {
...
pub(super) async fn generate_proof(compiled_circuit_path: &Path, pk_path: &Path, witness_path: &Path, proof_path: &Path) -> Result<String, EZKLError> {
